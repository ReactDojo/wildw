            ...
            <View style={{flex: 1}}>
                <Router createReducer={reducerCreate} getSceneStyle={getSceneStyle}>
                    <Scene key="root">
                        ...
                        <Scene key="welcome" hideNavBar={true} hideTabBar panHandlers={null} schema="modal"
                               direction="vertical">
                        ...
                        <Scene key="drawer" hideNavBar={true} drawer acceptTap={true} animated={true}
                               contentComponent={SideBar} drawerWidth={192}>
                            <Scene key="main">
